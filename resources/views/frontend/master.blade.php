...
<div class="wrapper">
    ...
    <div class="navbar navbar-expand-md mb-0 nav-wrapper" role="navigation">
        <a class="navbar-brand ml-3 mr-5" href="{{route('home')}}">Suchona</a>
            ...
            <ul class="navbar-nav mr-auto p-2">
                ...
                <li class="nav-item dropdown active" style="cursor:pointer">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown1">
                        <li class="dropdown-item" ><a href="{{route('course')}}">Graphic Design</a></li>
                        <li class="dropdown-item" ><a href="{{route('course')}}">Web Design </a></li>
                        <li class="dropdown-item" ><a href="{{route('course')}}">Web Development</a></li>
                        <li class="dropdown-item" ><a href="{{route('course')}}">Affiliate Marketing</a></li>
                    </ul>
                </li>
                <li class="nav-item active">
    ...
    <div class="footer wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-link">
                        <h2>Hot courses</h2>
                        <a href="{{route('course')}}">Web design and development</a>
                        <a href="{{route('course')}}">Graphics Design</a>
                        <a href="{{route('course')}}">Programming for kids</a>
                        <a href="{{route('course')}}">Spoken English</a>
                        <a href="{{route('course')}}">Video editing</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="footer-link">
                        ...
                        <a href="{{route('home')}}">Our Team</a>
                        <a href="{{route('course')}}">Projects</a>
                        <a href="{{route('course')}}">Testimonial</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
        ...
        <div class="container footer-menu">
            <div class="f-menu">
                <a href="{{route('course')}}">Terms of use</a>
                <a href="{{route('course')}}">Privacy policy</a>
                <a href="{{route('course')}}">Cookies</a>
        ...
        <div class="container copyright">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; <a href="#">suchona.com</a>, All Right Reserved.</p>
                </div>
                <div class="col-md-6">
                    <p>Designed By <a href="https://htmlcodex.com">Team Suchona</a></p>
                </div>
            </div>
        </div>
    </div>
